...
const RewardDetailDrawer: React.FC<RewardDetailDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-40 flex">
      ...
      <aside className="relative ml-auto bg-white w-full max-w-2xl h-full flex flex-col md:flex-row">
        <div className="flex-1 p-6">
          ...
          <div className="rounded-xl bg-[#f5f7fa] flex items-center justify-center h-64 mb-6">
            <img
          ...
          <div className="space-y-6 text-[#1e2a63]">
            <div>
              ...
              <p className="text-sm text-[#75787b] whitespace-pre-line">{reward.description || "Sem descrição."}</p>
            </div>
        ...
        <aside className="w-full md:max-w-sm p-6 bg-[#f5f7fa] flex flex-col">
          ...
          <button onClick={onClose} className="w-full py-2 text-center rounded-lg border border-gray-300">
            Voltar
          </button>
        </aside>
      </aside>
